...
namespace Inheritance.Tests
{
    ...
    public class InheritanceTests
    {
        ...
        [TestCaseSource(nameof(MethodsData))]
        ...
        public void MethodExistAdvance(string className, string methodName, Type returnType,
        ...
        public void CompanyClassFunctionalityTest(object[] employees, string maxPayHolderBeforeBonus,
            string maxPayHolderAfterBonus,
        ...
        private static IEnumerable<TestCaseData> FunctionalData
        {
            get
            {
                ...
                var managerConstructor =
                    managerType.GetConstructor(new[] {typeof(string), typeof(decimal), typeof(int)});
                var salesPersonType = GetClass("SalesPerson");
                var salesPersonConstructor =
                    salesPersonType.GetConstructor(new[] {typeof(string), typeof(decimal), typeof(int)});
        ...
        {
            var classType = Type.GetType($"InheritanceTask.{className}, InheritanceTask");
